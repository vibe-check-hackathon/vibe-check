    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-4xl px-6 py-8 space-y-8">
        ...
        <section>
          ...
          <p className="mt-2 text-[10.5px] text-muted-foreground">
            Independent public resources, not sponsored or affiliated with FirstCheck. Links go to a search for each
            show's name rather than one specific episode, so they never point somewhere stale.
          </p>
        </section>
      </div>
    </div>
