...
**One-line pitch:** The API for carbon intelligence — embed emission
calculations into any software product (Berlin).
...
### FND-MGV-0007 - Founding team

- **Founder Score snapshot:** not assessed — no fabricated evaluations of real people
- Founder names and backgrounds not verified here [GAP-001]
...
| CLM-002 | API-first carbon accounting positioning | verified | 80/100 | [SRC-001] portfolio description |
| GAP-001 | Founder names, round size, and date | open | unknown | Check press coverage |
