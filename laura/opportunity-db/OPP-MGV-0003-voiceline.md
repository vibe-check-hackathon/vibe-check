...
**One-line pitch:** The Voice AI platform for the enterprise frontline — field
sales teams capture and act on customer interactions by voice (Munich).
...
Real deal: €10M Series A led by ALSTIN Capital and Peak, with continued backing
from Scalehouse Capital, Venture Stars, and NAP [CLM-001][SRC-002]. Preceded by
a €2.4M seed (2024) led by Venture Stars and Scalehouse Capital [CLM-002][SRC-003].

## Founders and Team

### FND-MGV-0005 - Dr. Nicolas Höflinger, CEO & co-founder
...
🔒 **Confidential — no public founder interview found** (searched 2026-07-19).
In the live system this card would show the locked state: interview evidence
exists only inside the fund's consented, recorded sessions.

## Decision

- **Real-world outcome:** ALSTIN co-led the €10M Series A (2026-02-24) —
